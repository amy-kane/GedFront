...
const MembreComiteLayout = ({ children }) => {
  ...
  const navigateToStatistics = () => {
    ...
    router.push('/membre-comite/statistiques');
  };
          ...
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Gestion Electronique des Documents</p>
                </div>
              </div>
              ...
              <h2 className="text-lg font-semibold text-gray-700">
                ...
                {!pathname?.includes('/membre-comite/') && 'Comité d\'évaluation'}
              </h2>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                {/* Profile Button */}
                <button 
                  className="p-2 text-gray-400 hover:text-purple-600 hover:bg-purple-50 rounded-full transition-all duration-200 border border-transparent hover:border-purple-200"
          ...
          <aside className={`${sidebarCollapsed ? 'w-16' : 'w-64'} bg-white rounded-xl shadow-lg transition-all duration-300 flex flex-col`}>
            ...
            <nav className="flex-1 px-3 py-4 space-y-2 overflow-y-auto">
              ...
              <NavItem 
                icon={<ChartIcon />} 
                text="Statistiques" 
                active={isActive('/membre-comite/statistiques')}
                ...
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full flex items-center justify-center mr-3">
                    <span className="text-white font-semibold text-sm">
                      {user ? `${user.prenom?.[0]}${user.nom?.[0]}` : 'M'}
                    </span>
                  </div>
